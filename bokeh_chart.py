...
class BokehMixin:
    def bokeh_chart(self, figure, use_container_width=False, theme=None):
        ...
        marshall(bokeh_chart_proto, figure, use_container_width, theme)
...
def marshall(proto, figure, use_container_width, theme):
    ...
    data = json_item(figure, theme=theme)
